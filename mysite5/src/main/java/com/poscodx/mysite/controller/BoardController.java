...
public class BoardController {
    ...
    public String delete(@PathVariable("no") Long no, Authentication authentication) {
    ...
    public String modifyForm(@RequestParam("no") Long no, Authentication authentication, Model model) {
        UserVo authUser = (UserVo) authentication.getPrincipal();
        if (authUser == null) {
